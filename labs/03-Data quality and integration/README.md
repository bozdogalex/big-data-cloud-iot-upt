...
From the repository root, run `docker compose -f compose.release.yaml up -d`, then `docker compose -f compose.release.yaml logs lab` to find the Jupyter login URL. Open it and navigate to `labs/03-Data quality and integration/03_data_quality.ipynb`.
