...
Identify duplicates and missing observations and interpret their effects.

## Session outline

Run the guided heart-rate notebook; compare an average with the available readings.

## Before the lab — predict
...
## After the lab — practise and reflect
